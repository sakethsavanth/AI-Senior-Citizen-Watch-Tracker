1. **Monitor Agent** (OpenRouter Claude): Polls Whoop API hourly via Lambda— "HRV 35 + low steps = walk reminder needed."
...
| Orchestration | LangChain/LangGraph on OpenRouter | Memory of prefs/meds. |
