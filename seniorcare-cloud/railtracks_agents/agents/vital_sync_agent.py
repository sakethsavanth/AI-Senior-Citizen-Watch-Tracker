...
VitalSyncAgent = rt.agent_node(
    ...
    system_message=(
        ...
        "2. Generate a daily message based on time of day:\n"
        ...
        "3. If HRV is low, append a doctor visit warning.\n"
        "4. Report severity: critical (fall), high (HRV low), low (normal).\n"
        "5. Set alert_family=true if severity is critical or high.\n\n"
        "Return a JSON with: severity, daily_message, alert_family, and assessment details."
    ),
